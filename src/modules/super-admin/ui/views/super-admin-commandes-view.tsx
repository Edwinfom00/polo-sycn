...
interface SuperAdminCommandesViewProps {
...
export const SuperAdminCommandesView = ({ commandes: initialCommandes }: SuperAdminCommandesViewProps) => {
    const [filter, setFilter] = useState<string>('all');
    const [search, setSearch] = useState("");
    const [currentPage, setCurrentPage] = useState(1);
    const itemsPerPage = 9; // 3 par ligne x 3 lignes
    ...
    return (
        <div className="flex-1 space-y-6 p-6">
            ...
            {/* Grille des commandes - 3 par ligne */}
                ...
                <Card>
                    <CardContent className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="text-sm text-muted-foreground">
                            {search ? "Aucun résultat pour cette recherche" : "Aucune commande trouvée"}
                        </p>
                    </CardContent>
                </Card>
            ) : (
                        ...
                        {currentCommandes.map((commande) => (
                            <Card key={commande.id} className="hover:shadow-lg transition-shadow">
                                ...
                                <CardContent className="space-y-3">
                                    ...
                                    <div className="pt-2">
                                        <Link href={`/super-admin/orders/${commande.id}`} className="w-full">
